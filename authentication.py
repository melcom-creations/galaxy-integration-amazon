...
class START_URI():
    SPLASH = Path(_DIRNAME, 'modules', 'splash', 'index.html').resolve().as_uri() + '?view=splash'
    MISSING_APP = Path(_DIRNAME, 'modules', 'splash', 'index.html').resolve().as_uri() + '?view=missing-app'
